...
function populateTable(jsonObj) {
	...
	for (var i = 0; i < alunos.length; i++) {
		...
		var frequencia = alunos[k].frequencia;
		for (var l = 0; l < frequencia.length; l++) {
			...
			heading_2.textContent = frequencia[l].matematica;
			heading_3.textContent = frequencia[l].portugues;
			heading_4.textContent = frequencia[l].historia;
			heading_5.textContent = frequencia[l].geografia;
			heading_6.textContent = frequencia[l].ingles;
			heading_7.textContent = frequencia[l].desenho;
			heading_8.textContent = frequencia[l].musica;
	...
	for (var m = 0; m < alunos.length; m++) {
		...
		var frequencia = alunos[m].frequencia;
		for (var n = 0; n < frequencia.length; n++) {
			...
			heading_2.textContent = frequencia[n].matematica;
			heading_3.textContent = frequencia[n].portugues;
			heading_4.textContent = frequencia[n].historia;
			heading_5.textContent = frequencia[n].geografia;
			heading_6.textContent = frequencia[n].ingles;
			heading_7.textContent = frequencia[n].desenho;
			heading_8.textContent = frequencia[n].musica;
